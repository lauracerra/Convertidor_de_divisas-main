...
import 'package:http/http.dart'
    as http; /*Paquete para obtener datos de internet*/
...
class _CurrencyConverterState extends State<CurrencyConverter> {
  // Color mainColor = Color.fromARGB(255, 136, 163, 206);
  ...
  Future<String> _getJSONData() async {
    /*La carga de monedas devolvera una cadena, por lo que se usa el Future, porque el Future tiene una propiedad que que le dice a la funcion que la cadena la devolvera en el futuro, por lo que no la devolvera de inmediato*/
    var url = Uri.parse("https://api.frankfurter.app/latest");
    var response = await http.get((url), headers: {
      "Accept": "application/json"
    }); /*Usando el metodo http.get obtendremos una muestra de la API. Como http.get no puede trabajar con cadenas anteriormente en la variable url se utiliza URI.parse para analizar la direccion HTTP*/
    var responseBody = json.decode(response
        .body); /*Se extrae el cuerpo de respuesta obteniendo los datos en formato JSON*/
    Map curMap = responseBody[
        'rates']; /*Aqui filtraremos lo que nos envia de la API para que solo nos muestre los 'rates' o sea las divisas unicamente y no toda la lista de String*/
    /*La razon por la que se usa Map es que arroja un par de valores de key y valor o sea la divisa y cuanto cuesta*/
    currencies =
        curMap.keys.toList(); /*Convertimos los datos en una Lista de valores*/
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 105, 132, 175),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          height: 250,
                          child: Image.asset('assets/icono_proyecto.png'),
                        ),
                        Expanded(
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  title: TextField(
                                    decoration: InputDecoration(
                                        filled: true,
                                        fillColor:
                                            Color.fromARGB(204, 243, 239, 239),
                                        labelText: "Convertir",
                                        labelStyle: TextStyle(
                                            fontWeight: FontWeight.normal,
                                            fontSize: 18.0,
                                            color: Color.fromARGB(255, 136, 163, 206))),
                                ...
                                Row(
                                    ...
                                    children: [
                                      ...
                                      FloatingActionButton(
                                          ...
                                          elevation: 0.0,
                                          backgroundColor: Color.fromARGB(255, 61, 3, 168)),
                                ...
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: Color.fromARGB(204, 243, 239, 239),
